...
import type { DashboardBadge, DashboardStats } from '@/app/dashboard/helpers/fetchDashboard';
...
export function RightSidebar({ stats, badges, className }: RightSidebarProps) {
  return (
    <aside
